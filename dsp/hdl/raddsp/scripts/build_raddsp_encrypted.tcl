...
set build_dir [file join $raddsp_hdl_dir build encrypted_project]
...
create_project -force raddsp_encrypted $build_dir -part xczu3eg-sfvc784-1-e
set_property target_language VHDL [current_project]
set_property simulator_language Mixed [current_project]
set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]

raddsp_check_files $raddsp_release_files
read_vhdl -vhdl2008 -library raddsp $raddsp_release_files
...
puts "PASS raddsp encrypted library testbenches"
