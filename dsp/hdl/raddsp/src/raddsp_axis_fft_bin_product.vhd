...
begin
  ...
  begin
    ...
    arbr_i: entity work.raddsp_mul
      generic map (VENDOR => VENDOR, DEVICE_FAMILY => DEVICE_FAMILY, A_WIDTH => DATA_WIDTH, B_WIDTH => DATA_WIDTH)
