...
-- Portable simulation model for the subset of xpm_fifo_sync used by RadDSP.
-- Synthesis builds should use the vendor FIFO primitive or a build-selected implementation.
...
architecture sim of xpm_fifo_sync is
  ...
  type mem_t is array (0 to DEPTH - 1) of std_logic_vector(WRITE_DATA_WIDTH - 1 downto 0);
