...
entity radif_spi_slave_to_reg is
  generic (
...
architecture rtl of radif_spi_slave_to_reg is
  ...
  begin
    if rising_edge(clk) then
      ...
      if rstn = '0' then
        ...
        elsif tx_index > 0 and tx_index < WORD_BYTES and sclk_sync = '0' and sclk_prev = '1' and bit_count = "000" then
