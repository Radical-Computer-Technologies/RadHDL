...
-- AXI-accessible debug hub for RadHDL instrumentation cores.
-- Provides register access and coordination points for debug blocks that need host-visible control, status, and capture data.
